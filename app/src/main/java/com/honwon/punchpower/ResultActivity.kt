        ...
        class ResultActivity : AppCompatActivity() {
            ...
            fun uploadScore() {
                ...
                user?.let {
                    ...
                    leaderboard.submitScoreImmediate(getString(R.string.leaderboard), power.toLong()).addOnSuccessListener {
                        leaderboard.getLeaderboardIntent(getString(R.string.leaderboard))
